...
import com.teddy.Repository.UserRegisterRepository;
...
public class UserRegisterServiceImpl implements UserRegisterService{
	...
	@Autowired
	private UserRegisterRepository userRegisterRepositoy;
	...
	public UserRegisterDetails insertUserRegister(UserRequestDto userRequestDto) {
		...
		userRegisterRepositoy.save(user);
